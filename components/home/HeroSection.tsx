...
export function HeroSection() {
  ...
  return (
    <section className="relative h-[380px] md:h-[460px] lg:h-[400px] overflow-hidden bg-gradient-to-r from-[#8B4513] to-[#D2691E]">
      {/* Background Images */}
      {heroSlides.map((slide, index) => (
        <div
          key={slide.id}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
            <div className="text-white space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-[#ff5722] to-[#e64a19] hover:from-[#e64a19] hover:to-[#d84315] text-white px-6 py-2 text-base font-semibold"
                >
                  {heroSlides[currentSlide].cta}
                </Button>
                <Button 
                  variant="outline" 
                  size="lg"
                  className="border-2 border-white text-white hover:bg-white hover:text-gray-900 px-6 py-2 text-base font-semibold bg-transparent"
                >
                  <Search className="h-5 w-5 mr-2" />
                  Search Ads
                </Button>
